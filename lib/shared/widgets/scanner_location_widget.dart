...
class LocationScannerWidget extends StatefulWidget {
  ...
  @override
  State<LocationScannerWidget> createState() => _LocationScannerWidgetState();
}

class _LocationScannerWidgetState extends State<LocationScannerWidget> {
  Timer? _debounce;
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: widget.locationIsOk ? Colors.green : Colors.amber,
              shape: BoxShape.circle,
            ),
          ),
        ),
        Card(
          color: widget.isLocationOk
              ? widget.locationIsOk
                  ? Colors.green[100]
                  : Colors.grey[300]
              : Colors.red[200],
