// lib/features/inventario/presentation/pages/inventario_page.dart
...
import 'package:wms_app/features/inventario/presentation/widgets/location_card_button_widget.dart';
import 'package:wms_app/features/inventario/presentation/widgets/dialog_barcodes_widget.dart';
...
class _InventarioScreenState extends State<InventarioScreen>
  ...
  void validateLocation(String value) {
    ...
    UbicacionInventario? matchedUbicacion = bloc.ubicaciones.firstWhere(
      (ubicacion) => ubicacion.barcode?.toLowerCase() == scan.trim(),
      orElse: () => const UbicacionInventario(),
    );
  ...
  void validateLote(String value) {
    ...
    LoteProductoInventario? matchedLote = bloc.listLotesProduct.firstWhere(
      (lotes) => lotes.name?.toLowerCase() == scan.trim(),
      orElse: () => const LoteProductoInventario(),
    );
  ...
  bool validateScannedBarcode(
    ...
    BarcodeProducto? matchedBarcode = bloc.barcodeInventario.firstWhere(
