...
/// Espejo de RecepcionClaimCardWidget. El progreso usa qtyAlmacenada (lo que
/// ya se guardó en destino), que es el equivalente de qtyRecibida para
/// transferencias — el doc del backend lo confirma como alias.
class TransferenciaClaimCardWidget extends StatelessWidget {
  const TransferenciaClaimCardWidget({
    super.key,
    required this.claim,
  ...
  Widget build(BuildContext context) {
    ...
    final almacenada = claim.qtyAlmacenada ?? 0;
    final progress = asignada > 0
        ? (almacenada / asignada).clamp(0.0, 1.0)
        : 0.0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Almacenado: $almacenada / $asignada ${claim.uom ?? ''}',
                style: TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
