...
/// y la novedad si tuvo. Espejo de RecepcionNovedadesDialogWidget.
///
...
///
/// Es una lista, así que hace scroll (mismo fix de width: double.maxFinite
/// que dialog_barcodes_widget.dart, necesario porque AlertDialog envuelve
/// su content en un IntrinsicWidth).
///
/// Incluye un filtro para ver solo las asignaciones del usuario actual
/// (compara TransferenciaAsignacionObservacion.operarioId contra
/// PrefUtils.getUserId()).
class TransferenciaNovedadesDialogWidget extends StatefulWidget {
  const TransferenciaNovedadesDialogWidget({
    super.key,
  ...
  /// Unidad de medida del producto (TransferenciaPoolItem.uom) — solo para
  /// mostrarla junto a las cantidades de cada asignación.
  final String? uom;

  @override
  State<TransferenciaNovedadesDialogWidget> createState() =>
      _TransferenciaNovedadesDialogWidgetState();
}

class _TransferenciaNovedadesDialogWidgetState
    extends State<TransferenciaNovedadesDialogWidget> {
