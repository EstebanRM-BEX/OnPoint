...
/// Espejo de RecepcionPoolItemCardWidget, con una línea extra:
/// "Almacenado" (qtyAlmacenada), que no existe en recepción.
class TransferenciaPoolItemCardWidget extends StatelessWidget {
  const TransferenciaPoolItemCardWidget({
    super.key,
    required this.item,
