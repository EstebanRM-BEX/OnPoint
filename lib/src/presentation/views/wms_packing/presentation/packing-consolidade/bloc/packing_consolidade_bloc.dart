...
//metodo para enviar una imagen de novedad
  ...
  void _onSelectAllProductsPackingEvent(SelectAllProductsPackingEvent event,
    ...
    try {
      ...
      emit(SelectAllProductsPackingLoadedState(
          listOfProductsForPacking: listOfProductsForPacking));
    } catch (e, s) {
  ...
  void _onUnSelectAllProductsPackingEvent(
    ...
    try {
      listOfProductsForPacking = [];
      emit(UnSelectAllProductsPackingLoadedState(
          listOfProductsForPacking: listOfProductsForPacking));
    } catch (e, s) {
    ...
    try {
      for (final apiPedido in apiPedidos) {
        ...
        final localByMove = await db.productosPedidosRepository.countRowsByMove(
            apiPedido.id!, 'packing-batch-consolidate');
        ...
        await db.productosPedidosRepository.deleteProductsNotInMoves(
            apiPedido.id!, apiMoves.toList(), 'packing-batch-consolidate');
      }
    } catch (e, s) {
