      ...
      listener: (context, state) {
        if (state is AssignUserToOrderFailure) {
          ...
          context.read<RecepcionBloc>().add(
            GetPorductsToEntrada(state.ordenCompra.id ?? 0, 'dev'),
          );
          context.read<RecepcionBloc>().add(
                        ...
                        ? Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  'Intente buscar otra devolucion',
      ...
      showDialog(
        ...
        builder: (dialogContext) => DialogStartTimeWidget(
          onAccepted: () async {
            ...
            recepcionBloc.add(SearchDevolucionEvent(''));
            recepcionBloc.add(
              StartOrStopTimeOrder(ordenCompra.id ?? 0, "start_time_reception"),
            );
